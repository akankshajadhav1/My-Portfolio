...
const About = () => {
  return (
    <section id="about" className='w-full min:h-screen bg-gradient-to-br from-[#FFFBF1] via-[#FFF6E5] to-[#F5E6D3] py-12 md:py-24 px-4 md:px-8'>

      {/* Section Header */}
      <div className='text-center mb-8 md:mb-16'>
        <h2 className='text-lg sm:text-xl md:text-2xl lg:text-4xl font-bold text-[#4B2E2B] mb-3 md:mb-4 tracking-tight'>
          Who I am
        </h2>
        <h3 className='text-xl sm:text-2xl md:text-2xl lg:text-4xl font-normal text-[#853953] font-serif mb-4 tracking-tight px-2'>
          Pushing the boundaries of web development with creativity and passion.

        </h3>

        <div className='w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 md:mt-7'>
          {/* left */}
          <div className='w-full space-y-2 flex flex-col items-center mt-3 md:mt-5'>
            <div className='w-56 h-56 sm:w-72 sm:h-72 md:w-96 md:h-96 rounded-lg shadow hover:shadow-lg bg-[#2C2C2C] -rotate-3 hover:rotate-0 transition-all duration-150 ease-in-out flex items-center justify-center mx-auto' >
              <img src={Profile} alt="Profile" className='w-52 h-52 sm:w-68 sm:h-68 md:w-92 md:h-92 rounded-lg object-cover contrast-125 brightness-110' />
            </div>
            <div className='w-full flex items-center justify-center gap-6 sm:gap-8 mt-4'>
          ...
          <div className='w-full space-y-4 md:space-y-6 mt-4 md:mt-6'>
            <p className='text-[#4B2E2B] text-sm md:text-base leading-relaxed tracking-wide text-center md:text-left'>

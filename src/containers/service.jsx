...
const Service = () => {
  return (
    <section id='services' className='w-full container mx-auto px-4 sm:px-6 relative pt-10 md:pt-32 pb-10 md:pb-32 flex flex-col items-center justify-start'>
      <h2 className='text-lg sm:text-xl md:text-4xl lg:text-5xl font-bold font-serif italic text-[#4B2E2B] mb-4 md:mb-4 tracking-tight'>
        HELLO!
      </h2>

      {/* Mobile/Tablet: stacked layout; Desktop: 5-column grid */}
      <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto] lg:grid-cols-5 gap-4 md:gap-6 items-center">

        {/* Left pills */}
        <div className="w-full flex flex-row md:flex-col items-center justify-center gap-2 md:gap-6 lg:col-span-1">
          {/* first one */}
        ...
        <div className="flex items-center justify-center w-full lg:col-span-3">
          <p className="text-center text-neutral-800 font-normal font-serif tracking-wider sm:tracking-widest text-base sm:text-lg md:text-3xl lg:text-4xl w-full leading-snug sm:leading-normal">
